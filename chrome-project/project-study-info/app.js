...
// ** 배열 & 객체 차이점
// - 데이터 구조:
//     배열 ([]): 순서가 있는 데이터의 목록. 숫자 인덱스를 사용하여 요소에 접근.
//     객체 ({}): 키-값 쌍으로 구성된 데이터. 키를 사용하여 값에 접근.
//
// - 데이터 접근 방식:
//     배열: arr[index]
//     객체: obj.key 또는 obj['key']
//
// - 사용 목적:
//     배열: 순서가 중요한 목록을 다룰 때.
//     객체: 다양한 속성을 가진 엔티티를 다룰 때.
//
// - 메서드와 속성:
//     배열: push, pop, shift, unshift, map, filter, reduce 등 다양한 배열 메서드를 제공.
//     객체: 객체의 속성을 조작하는 메서드 (Object.keys, Object.values, Object.entries) 등이 있음.
//
// - 배열 ([]): 순서가 있는 데이터의 목록을 관리하는 데 사용합니다.
// - 객체 ({}): 키-값 쌍으로 구성된 데이터 구조를 관리하는 데 사용합니다.
